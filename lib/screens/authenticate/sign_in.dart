...
import 'package:order_vegetables_employee/screens/authenticate/register.dart';
import 'package:order_vegetables_employee/services/auth.dart';
import 'package:order_vegetables_employee/shared/loading.dart';
    ...
    return loading
        ...
        : Scaffold(
            ...
            appBar: AppBar(
              ...
              elevation: 0.0,
              centerTitle: true,
              title: Text('Sign In to OV ADMIN'),
              actions: <Widget>[
                FlatButton.icon(
                    onPressed: () {
                      widget.toggleView();
